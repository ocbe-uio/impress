...
aic_table 
```
## Diagnostic plots for the primary model fit
```{r }
# Residual plots for the three models
plot_mmrm_residuals <- function(model, title) {
    plot_data <- tibble(
        fitted = fitted(model),
...
plot_mmrm_residuals(m, "Residuals vs Fitted - Unstructured")
plot_mmrm_residuals(m2, "Residuals vs Fitted - Autoregressive")
plot_mmrm_residuals(m3, "Residuals vs Fitted - Compound Symmetry")
```
